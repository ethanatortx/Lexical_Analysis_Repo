...
namespace hash
{
	namespace algorithm
	{
		...
		template <class hash_alg = hash::algorithm::SHA256>
		std::string hash(std::string input)
		{
			...
			char buf[2*hash_alg::DIGEST_SIZE+1];
			buf[2*hash_alg::DIGEST_SIZE] = 0;
			for (int i = 0; i < hash_alg::DIGEST_SIZE; i++)
	...
	namespace error
	{
		/*
		TODO						
		dont want to deal with error catching right now
		*/
	}
	...
	public:
		hash_table();
		hash_table(const hash_table<type, hash_alg, col_check>& other);
